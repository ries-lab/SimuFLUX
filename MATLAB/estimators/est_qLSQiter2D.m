...
{((L^2 + 4*(x0^2 + y0^2))*(-2*x0*(L + 4*d13*y0) + d24*(L^2 + 4*(x0 - y0)*(x0 + y0))))/(2*(L^3 - 4*L*(x0^2 + y0^2))), 
 -1/2*((L^2 + 4*(x0^2 + y0^2))*(2*(L - 4*d24*x0)*y0 + d13*(L^2 - 4*x0^2 + 4*y0^2)))/(L^3 - 4*L*(x0^2 + y0^2))}
...
dr(1)=((L^2 + 5*(x0^2 + y0^2))*(x0*(L^3*(-3 + ps) - 15*d13*L^2*y0 + 5*L*(4 + ps)*(x0^2 + y0^2) + 100*d13*y0*(x0^2 + y0^2)) + ...
    d24*(2*L^4 - 15*L^2*y0^2 + 50*(-x0^4 + y0^4))))/(4*L^5 - 30*L^3*(x0^2 + y0^2) + 100*L*(x0^2 + y0^2)^2); 

dr(2)= -(((L^2 + 5*(x0^2 + y0^2))*(-(y0*(L^3*(-3 + ps) + 15*d24*L^2*x0 + 5*L*(4 + ps)*(x0^2 + y0^2) - 100*d24*x0*(x0^2 + y0^2))) +... 
     d13*(2*L^4 - 15*L^2*x0^2 + 50*(x0^4 - y0^4))))/(4*L^5 - 30*L^3*(x0^2 + y0^2) + 100*L*(x0^2 + y0^2)^2));
...
dr(1)=-1/4*((L^2 + 4*(x0^2 + y0^2))*(L^2*(p1 - p2 - 2*p3 - p4 + p5 + 2*p6) + 4*L*x0 + ...
     4*(-2*p3*x0^2 - p4*x0^2 + p5*x0^2 + 2*p6*x0^2 - 2*sqrt(3)*p4*x0*y0 - 2*sqrt(3)*p5*x0*y0 + 2*p3*y0^2 + p4*y0^2 - p5*y0^2 - ...
       2*p6*y0^2 + p1*(x0^2 + 2*sqrt(3)*x0*y0 - y0^2) + p2*(-x0^2 + 2*sqrt(3)*x0*y0 + y0^2))))/(L^3 - 4*L*(x0^2 + y0^2)); 
 dr(2)=-1/4*((L^2 + 4*(x0^2 + y0^2))*(sqrt(3)*L^2*(p1 + p2 - p4 - p5) + 4*L*y0 + ...
     4*(sqrt(3)*p4*x0^2 + sqrt(3)*p5*x0^2 - 4*p3*x0*y0 - 2*p4*x0*y0 + 2*p5*x0*y0 + 4*p6*x0*y0 - sqrt(3)*p4*y0^2 - sqrt(3)*p5*y0^2 + ...
       p2*(-(sqrt(3)*x0^2) - 2*x0*y0 + sqrt(3)*y0^2) + p1*(-(sqrt(3)*x0^2) + 2*x0*y0 + sqrt(3)*y0^2))))/(L^3 - 4*L*(x0^2 + y0^2));
...
%     (9*L^5 - 70*L^3*(x0^2 + y0^2) + 196*L*(x0^2 + y0^2)^2);
dr(1)=-1/12*((3*L^2 + 14*(x0^2 + y0^2))*(9*L^4*(p1 - p2 - 2*p3 - p4 + p5 + 2*p6) + 6*L^3*(5 - 6*p0 + p1 + p2 + p3 + p4 + p5 + p6)*x0 + ...
     70*L^2*y0*(sqrt(3)*p1*x0 + sqrt(3)*p2*x0 - sqrt(3)*p4*x0 - sqrt(3)*p5*x0 - p1*y0 + p2*y0 + 2*p3*y0 + p4*y0 - p5*y0 - 2*p6*y0) - ...
     28*L*(6 + 6*p0 - p1 - p2 - p3 - p4 - p5 - p6)*x0*(x0^2 + y0^2) + 196*(x0^2 + y0^2)*(2*p3*x0^2 + p4*x0^2 - p5*x0^2 - 2*p6*x0^2 + ...
       2*sqrt(3)*p4*x0*y0 + 2*sqrt(3)*p5*x0*y0 - 2*p3*y0^2 - p4*y0^2 + p5*y0^2 + 2*p6*y0^2 + p2*(x0^2 - 2*sqrt(3)*x0*y0 - y0^2) + ...
       p1*(-x0^2 - 2*sqrt(3)*x0*y0 + y0^2))))/(9*L^5 - 70*L^3*(x0^2 + y0^2) + 196*L*(x0^2 + y0^2)^2); 
dr(2)= -1/12*((3*L^2 + 14*(x0^2 + y0^2))*(9*sqrt(3)*L^4*(p1 + p2 - p4 - p5) + 6*L^3*(5 - 6*p0 + p1 + p2 + p3 + p4 + p5 + p6)*y0 - ...
     70*L^2*x0*(sqrt(3)*p1*x0 + sqrt(3)*p2*x0 - sqrt(3)*p4*x0 - sqrt(3)*p5*x0 - p1*y0 + p2*y0 + 2*p3*y0 + p4*y0 - p5*y0 - 2*p6*y0) - ...
     28*L*(6 + 6*p0 - p1 - p2 - p3 - p4 - p5 - p6)*y0*(x0^2 + y0^2) + 196*(x0^2 + y0^2)*(-(sqrt(3)*p4*x0^2) - sqrt(3)*p5*x0^2 + ...
       4*p3*x0*y0 + 2*p4*x0*y0 - 2*p5*x0*y0 - 4*p6*x0*y0 + sqrt(3)*p4*y0^2 + sqrt(3)*p5*y0^2 + ...
       p1*(sqrt(3)*x0^2 - 2*x0*y0 - sqrt(3)*y0^2) + p2*(sqrt(3)*x0^2 + 2*x0*y0 - sqrt(3)*y0^2))))/...
   (9*L^5 - 70*L^3*(x0^2 + y0^2) + 196*L*(x0^2 + y0^2)^2);
